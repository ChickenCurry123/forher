...
const body = document.querySelector('body') // biasanya tag body itu tanpa titik (class)
...
// Fungsi dayID dan monthID harus kamu definisikan sendiri ya
hari.innerHTML = `${dayID()}, ${tgl} ${monthID()} ${year}`
jam.innerHTML = `${hour}:${minutes}`

// Dirubah 
const pengirim = "Masa Depan mu! ";
const nomorWa = "62895603005825" // awalan nomor 0 harus diganti 62
